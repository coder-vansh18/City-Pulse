...
const STORAGE_KEY = 'citypulse_citizen_reports_v3';
...
const INITIAL_DEMO_REPORTS: CitizenReport[] = [
  ...
  },
  {
    ...
    description: 'Streetlight fixture #42 flickering and completely unlit, creating blind spots for nighttime cyclists.',
    images: [
    ...
    sla: {
      durationHours: 48,
      deadline: new Date(Date.now() + 3600000 * 34).toISOString(),
    ...
    aiAnalysis: {
      ...
      severity: 'medium',
      confidence: 89,
      visualEvidenceStrength: 'Moderate',
      descriptionMatchPercent: 82,
      descriptionConsistent: true,
      affectedArea: 'Residential Cross-Street',
      suggestedSla: '48 Hours',
      suggestedDepartment: 'Electrical & Lighting',
      recommendation: 'Replace ballast component and check feeder line voltage.',
      detectedIssue: 'Unlit LED Luminaire on Secondary Road',
    },
    civicImpact: {
      score: 54,
      trafficImpact: 35,
    ...
    evidence: {
      ...
      locationEvidence: {
        ...
        distanceToReportedMeters: 85,
        imageGpsAvailable: false,
        isConsistent: false,
        summary: 'Manual address entry without device GPS telemetry confirmation.',
      },
      scoreBreakdown: {
        totalScore: 48,
        strengthLabel: 'Insufficient / Needs Review',
        gpsMatch: 5,
        liveCapture: 0,
        aiImageMatch: 14,
        timestampConsistency: 6,
        locationConsistency: 6,
        communityConfirmation: 5,
        noDuplicate: 6,
        userAuthenticity: 6,
        explanation: 'EXIF metadata and browser GPS coordinates were unavailable at submission time.',
      },
      suspiciousFlags: [
        {
          flagType: 'Missing Metadata',
          message: 'Uploaded file has stripped EXIF tags and no device GPS header.',
          severity: 'low',
          requiresManualReview: true,
        },
      ],
      timeline: [
        { title: 'Report Submitted', timestamp: '08:45 PM', note: 'New resident account submission', passed: true },
        { title: 'Metadata Check', timestamp: '08:45 PM', note: 'Metadata unavailable in web upload', passed: false },
        { title: 'AI Classification', timestamp: '08:46 PM', note: 'Unlit streetlight (89% conf)', passed: true },
        { title: 'Status Assessment', timestamp: '08:46 PM', note: 'Flagged for preliminary verification', passed: true },
      ],
      requiresManualReview: true,
      manualReviewReason: 'Missing telemetry tags require community corroboration or inspector confirmation.',
    },
    timeline: createDefaultTimeline('submitted', new Date(Date.now() - 3600000 * 14).toISOString()),
  },
  {
    id: 'REP-2026-8935',
  ...
  },
  {
    id: 'REP-2026-8948',
    category: 'traffic',
    categoryLabel: 'Traffic Obstruction',
    priority: 'low',
    title: 'Faded Crosswalk Markings at Elementary School',
    description: 'Thermoplastic pedestrian striping has worn off, reducing vehicle yielding rates during drop-off hours.',
    images: [
      'https://images.unsplash.com/photo-1508873696983-2df5293cb325?auto=format&fit=crop&w=600&q=80',
    ],
    location: {
      address: 'University Quarter, School Lane',
      zoneId: 'z3',
      lat: 40.728,
      lng: -74.001,
      distanceMeters: 1450,
    ...
    isMyReport: true,
    confirmedByMe: false,
    department: 'Traffic Enforcement & Safety',
    sla: {
      durationHours: 72,
      deadline: new Date(Date.now() + 3600000 * 70).toISOString(),
    ...
    aiAnalysis: {
      ...
      confidence: 92,
      visualEvidenceStrength: 'Strong',
      descriptionMatchPercent: 90,
      descriptionConsistent: true,
      affectedArea: 'School Speed Zone',
      suggestedSla: '72 Hours',
      suggestedDepartment: 'Traffic Safety & Markings',
      recommendation: 'Re-apply high-visibility reflective pavement paint.',
      detectedIssue: 'Degraded Pavement Markings',
    },
    civicImpact: {
      score: 42,
      trafficImpact: 30,
    ...
    evidence: {
      ...
      imageMetadata: {
        hasExif: true,
        isOriginal: true,
        captureTimestamp: new Date(Date.now() - 3600000 * 2).toLocaleTimeString(),
        deviceModel: 'Mobile Camera',
      ...
      locationEvidence: {
        gpsCaptured: true,
        gpsAccuracyMeters: 9,
        distanceToReportedMeters: 18,
        imageGpsAvailable: true,
        isConsistent: true,
        summary: 'Location matched 18m from school crosswalk coordinates.',
      },
      scoreBreakdown: {
        totalScore: 82,
        strengthLabel: 'Strong Supporting Evidence',
        ...
        liveCapture: 18,
        aiImageMatch: 16,
        timestampConsistency: 9,
        locationConsistency: 9,
        communityConfirmation: 4,
        noDuplicate: 4,
        userAuthenticity: 4,
        explanation: 'High location and visual evidence score from authenticated resident.',
      },
      suspiciousFlags: [],
      timeline: [
        { title: 'Live Camera Capture', timestamp: '04:10 PM', note: 'Direct capture with GPS headers', passed: true },
        { title: 'AI Vision Analysis', timestamp: '04:11 PM', note: 'Pavement marking wear classified', passed: true },
        { title: 'Deduplication Scan', timestamp: '04:11 PM', note: 'No conflicting duplicate reports', passed: true },
      ],
      requiresManualReview: false,
    },
    timeline: createDefaultTimeline('submitted', new Date(Date.now() - 3600000 * 2).toISOString()),
  },
];
